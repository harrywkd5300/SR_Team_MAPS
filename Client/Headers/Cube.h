...
{
private:
	explicit CCube(LPDIRECT3DDEVICE9 pGraphicDev, const _uint& iDrawID, const TCHAR* pKey, CCube_Texture* pBufferCom);
...
public:
	static CCube* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos, _vec3 vRota, _vec3 vScalse, const _uint& iDrawID, const TCHAR* pKey, CCube_Texture* pBufferCom);
