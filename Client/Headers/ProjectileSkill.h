...
class CProjectileSkill : public CColliderSkill
{

private:
	explicit CProjectileSkill(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CProjectileSkill() = default;
public:
...
public:
	static CProjectileSkill* Create(LPDIRECT3DDEVICE9 pGraphicDev);
protected:
