#include "stdafx.h"
#include "..\Headers\CollCube.h"
#include "Camera_Manager.h"
#include "Collider_Manager.h"

CCollCube::CCollCube(LPDIRECT3DDEVICE9 pGraphicDev, const _uint& iDrawID, const TCHAR* pKey, CCube_Texture* pBufferCom)
...
_int CCollCube::LastUpdate_GameObject(const _float & fTimeDelta)
{
	...
	m_pColliderMgr->Add_BackGround(m_pColliderBox_AABB);
	m_pColliderMgr->Add_Target(m_pColliderBox_AABB);

	return 0;
}

void CCollCube::Render_GameObject()
{
...
void CCollCube::Render_Shadow(_matrix ShadowWorld)
{
	if (nullptr == m_pBufferCom || nullptr == m_pTransformCom)
		return;
...
HRESULT CCollCube::Ready_Component()
{
...
void CCollCube::TransForm(_vec3 vPos, _vec3 vRota, _vec3 vScale)
{
...
CCollCube * CCollCube::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 vPos, _vec3 vRota, _vec3 vScale, const _uint& iDrawID, const TCHAR* pKey, CCube_Texture* pBufferCom)
{
	CCollCube* pInstance = new CCollCube(pGraphicDev, iDrawID, pKey, pBufferCom);
