#include "stdafx.h"
#include "..\Headers\ProjectileSkill.h"
...
CProjectileSkill::CProjectileSkill(LPDIRECT3DDEVICE9 pGraphicDev)
	: CColliderSkill(pGraphicDev)
{

}

HRESULT CProjectileSkill::Ready_GameObject(void)
{
...
_int CProjectileSkill::Update_GameObject(const _float & fTimeDelta)
{
...
void CProjectileSkill::Render_GameObject(void)
{
...
_int CProjectileSkill::LastUpdate_GameObject(const _float & fTimeDelta)
{
	return CColliderSkill::LastUpdate_GameObject(fTimeDelta);
}

HRESULT CProjectileSkill::Ready_Component(void)
{
...
CProjectileSkill * CProjectileSkill::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CProjectileSkill *	pInstance = new CProjectileSkill(pGraphicDev);

	if (FAILED(pInstance->Ready_GameObject()))
	{
		MSG_BOX("CProjectileSkill Created Failed");
		Engine::Safe_Release(pInstance);
	}
	return pInstance;
}

_ulong CProjectileSkill::Free(void)
{
	_ulong		dwRefCnt = 0;
